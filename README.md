# bigdata-cloud
- Triển khai 1 bigdata framework, big data architecture (1 phần hoạc trọn vẹn với các module, software trong hệ sinh thái các công cụ dữ liệu lớn) -> cài đặt và demo
- Triển khai một mô hình, thuật toán trên xử lý phân tán giải quyết 1 vấn đề nào đó
- Triển khai một mô hình, thuật toán trên sử lý streaming để giải quyết 1 vấn đề nào đó
